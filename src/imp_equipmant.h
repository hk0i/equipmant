...
class Imp_equipmant: public QMainWindow, Ui::MainWindow
{
	...
	private:
		...
		void updateTitle(QString);				//changes the title to say whatever you put in here.
		void updateTitle(void);					//just puts app name and
												//version in title. This is called from updateTitle(QString).
		void setCurrentFile(QString);			//sets the current file and
												//updates titlebar. Yes this was intended
												//to be private; move it to public if you see fit.
